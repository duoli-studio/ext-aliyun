...
define(function (require) {
	...
	(function ($) {
			...
			return this.each(function () {
				...
				if ( text != undefined ) {
					$(this).hover(function (e) {
						var tipX = e.pageX + 12;
						var tipY = e.pageY + 12;
						$("body").append("<div id='plugin_tooltip' class='sl-plugin_tooltip'>" + text + "</div>" + "<div id='plugin_tooltip-shadow'  class='sl-plugin_tooltip-shadow'>" + text + "</div>");
						var tipWidth;
						if ( $.browser.msie ) {
		...
		// 跳跃滚动
		$.fn.plugin_scroll_jump = function (options) {
			//默认配置
			var defaults = {
				speed: 40,
				wait : 400
