<script>
	...
	export default {
		beforeRouteEnter(to, from, next) {
			...
			injection.http.get(`${window.api}/system/configuration/${path}`).then(response => {
...
<template>
    <div class="page-wrap">
        <tabs>
            <tab-pane :key="identification" :label="tab.title" :name="identification"
                      v-for="(tab, identification) in tabs">
                <card :bordered="false">
