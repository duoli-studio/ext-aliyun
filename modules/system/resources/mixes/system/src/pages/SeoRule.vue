                                ...
                                <div class="ivu-table-body" v-if="list.length">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        ...
                                        <tr class="ivu-table-row" v-for="(item, index) in list" v-if="item.show">
                                            <td>
                                                <div class="ivu-table-cell">
                                                    <form-item label=""
                                                        ...
                                                        <i-input :number="true" placeholder="请输入规则排序"
                                                                 v-model="item.order"></i-input>
                                                    </form-item>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="ivu-table-cell">
                                                    <router-link :to="`/seo/${$route.params.module}/${item.id}`"
                                                                 v-if="item.id">
                                                        <i-button size="small" style="margin-right: 10px"
                                                                  type="primary">编辑模板
                                                        </i-button>
                                                    </router-link>
                                                    <i-button size="small" type="danger" @click.native="remove(index)">
                                                        删除
                                                    </i-button>
                                                </div>
                                            </td>
