...
class BeRolePermissionMutation extends Mutation
{
	use SystemTrait;
	...
	public function __construct($attributes = [])
	{
		...
		$this->attributes['name']        = 'be_role_permission';
		$this->attributes['description'] = '[O]' . trans('system::role.graphql.mutation_permission');
	}
