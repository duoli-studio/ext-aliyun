 ...
 * @property string      $sex                           性别 男:man 女：female
 ...
 * @property int         $is_chid_validated             实名认证的状态 0:未认证, 1:已认证
 * @property int         $lol_is_girl_validated         lol是否认证过女猎手  0:未认证, 1:已认证
 * @property int         $wz_is_girl_validated          wz是否认证过女猎手  0:未认证, 1:已认证
 * @property int         $pubg_is_girl_validated        pubg是否认证过女猎手  0:未认证, 1:已认证
 * @property int         $lol_is_validated              lol是否认证过猎手  0:未认证, 1:已认证
 * @property string      $lol_validated_type            lol认证猎手级别:normal:普通猎手,good:优选猎手,gold:金牌猎手'
 * @property int         $wz_is_validated               wz是否认证过猎手  0:未认证, 1:已认证
 * @property string      $wz_validated_type             wz认证猎手级别:normal:普通猎手,good:优选猎手,gold:金牌猎手
 * @property int         $pubg_is_validated             pubg是否认证过猎手  0:未认证, 1:已认证
 * @property string      $pubg_validated_type           pubg认证猎手级别:normal:普通猎手,good:优选猎手,gold:金牌猎手
