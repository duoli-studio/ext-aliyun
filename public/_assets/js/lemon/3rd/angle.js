		...
		window.StateToggler = function () {
			...
			return {
				...
				addState: function (classname) {
					...
					Cookies.set('angle_'+storageKeyName, data);
				},
	...
	(function (window, document, $, undefined) {
		...
		$(function () {
			...
			$fsToggler.on('click', function (e) {
				...
				if (!$fsToggler.children('em').hasClass('fa-expand')) {
					util.exit_full_screen();
					toggleFSIcon($fsToggler, false);
				} else {
					...
					toggleFSIcon($fsToggler, true);
				}
			});


			function toggleFSIcon($element, is_fullscreen) {
				if (is_fullscreen)
...
// -----------------------------------
	...
	(function (window, document, $, undefined) {
		...
		$(function () {
			var angle_theme = Cookies.get('angle_theme');
			if(angle_theme) {
				$('[data-load-css="'+angle_theme+'"]').find('input').prop('checked', true);
			}
