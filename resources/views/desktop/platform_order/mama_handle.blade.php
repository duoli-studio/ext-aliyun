...
@can('mama_kf', $status)
    ...
    @endif
@endcan
@can('mama_lock', $status)
    @if (!$status->mama_is_lock)
...
<div id="detail_lock" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.lock', 'id' => 'form_lock']) !!}
    {!! Form::hidden('lock', \App\Lemon\Dailian\Application\Platform\Mama::LOCK_LOCK) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    <table class="table">
        <tr>
            <td>变更状态</td>
            <td>{!! \App\Lemon\Dailian\Application\Platform\Mao::kvLock(\App\Lemon\Dailian\Application\Platform\Mama::LOCK_LOCK) !!}</td>
        </tr>
        <tr>
            <td class="w108">理由:</td>
            <td>
...
<div id="detail_unlock" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.lock', 'id' => 'form_unlock']) !!}
    {!! Form::hidden('lock', \App\Lemon\Dailian\Application\Platform\Mama::LOCK_UNLOCK) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    <table class="table">
        <tr>
            <td>变更状态</td>
            <td>{!! \App\Lemon\Dailian\Application\Platform\Mama::kvLock(\App\Lemon\Dailian\Application\Platform\Mama::LOCK_UNLOCK) !!}</td>
        </tr>
        <tr>
            <td class="w108">理由:</td>
            <td>
...
<div id="detail_money" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.special', 'id' => 'form_money']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    {!! Form::hidden('type', \App\Lemon\Dailian\Application\Platform\Mama::MODIFY_MONEY) !!}
    <table class="table">
        <tr>
...
<div id="detail_time" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.special', 'id' => 'form_time']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    {!! Form::hidden('type', \App\Lemon\Dailian\Application\Platform\Mama::MODIFY_TIME) !!}
    <table class="table">
        <tr>
...
<div id="detail_game_pwd" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.special', 'id' => 'form_game_pwd']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    {!! Form::hidden('type', \App\Lemon\Dailian\Application\Platform\Mama::MODIFY_GAME_WORD) !!}
    <table class="table">
        <tr>
...
<div id="detail_picture" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.progress', 'id' => 'form_picture', 'files'=> true]) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    <table class="table">
        <tr>
            <td class="w108">图片:</td>
...
<div id="detail_star" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.star', 'id' => 'form_star']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    <table class="table">
        <tr>
            <td class="w108">评价:</td>
            <td>{!! Form::radios('flag', \App\Lemon\Dailian\Application\Platform\Mama::kvStar(), null, [
			  'desktop' => true
			]) !!} </td>
        </tr>
        <tr>
...
<div id="detail_cancel_apply" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.cancel', 'id'=> 'form_mao_pub_cancel']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    {!! Form::hidden('flag', \App\Lemon\Dailian\Application\Platform\Mama::PUB_CANCEL_APPLY) !!}
    <table class="table">
        <tr>
...
<div id="detail_cancel_cancel" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.cancel_cancel']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    {!! Form::hidden('flag', \App\Lemon\Dailian\Application\Platform\Mama::PUB_CANCEL_CANCEL) !!}
    <table class="table">
        <tr>
            <td class="w108">撤销标记:</td>
            <td>取消撤销</td>
...
<div id="detail_sd_cancel_handle" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.cancel_agree']) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    {!! Form::hidden('flag', \App\Lemon\Dailian\Application\Platform\Mama::PUB_CANCEL_AGREE) !!}
    <table class="table">
        <tr>
            <td class="w108">撤销标记:</td>
            <td>处理撤销</td>
        ...
        <tr>
            ...
            <td>
                <p class="mb5">
                    {!! Form::label('order_price', '您已预付的代练费') !!} ¥ {!! $status->mama_order_price !!} 元
                </p>
                <div class="form-group clearfix mb5 ">
...
<div id="detail_kf" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.kf', 'id' => 'form_kf']) !!}
    {!! Form::hidden('kf', \App\Lemon\Dailian\Application\Platform\Mama::KF_KF) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    <table class="table">
        <tr>
            <td>变更状态</td>
            <td>{!! \App\Lemon\Dailian\Application\Platform\Mama::kvKf(\App\Lemon\Dailian\Application\Platform\Mama::KF_KF) !!}</td>
        </tr>
        <tr>
            <td class="w108">理由:</td>
            <td>
...
<div id="detail_unkf" class="hidden">
    {!! Form::open(['route' => 'dsk_platform_status_mama.kf', 'id' => 'form_unkf']) !!}
    {!! Form::hidden('kf', \App\Lemon\Dailian\Application\Platform\Mama::KF_UNKF) !!}
    {!! Form::hidden('status_id', $status->id) !!}
    <table class="table">
        <tr>
            <td>变更状态</td>
            <td>{!! \App\Lemon\Dailian\Application\Platform\Mama::kvKf(\App\Lemon\Dailian\Application\Platform\Mama::KF_UNKF) !!}</td>
        </tr>
        <tr>
            <td class="w108">理由:</td>
            <td>
