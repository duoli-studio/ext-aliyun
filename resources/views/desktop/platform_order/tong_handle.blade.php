...
@endcan
@can('tong_progress', $status)
	<button class=" btn btn-primary btn-sm mr3 J_dialog text-info" data-title="更新进度"><span>更新进度</span></button>
@endcan
@can('tong_over', $status)
	<a class=" btn btn-primary btn-sm mr3 J_request J_delay text-danger" data-confirm="确认完成订单?" href="{!! route('dsk_platform_status_tong.over', [$status->id, $order->order_id]) !!}">
		<span> 确认完单</span>
	</a>
@endcan
@can('tong_star', $status)
...
<div id="detail_lock" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.lock', 'id' => 'form_lock']) !!}
	{!! Form::hidden('lock', \App\Lemon\Dailian\Application\Platform\Tong::LOCK_LOCK) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	<table class="table">
		<tr>
			<td>变更状态</td>
			<td>{!! \App\Lemon\Dailian\Application\Platform\Tong::kvLock(\App\Lemon\Dailian\Application\Platform\Tong::LOCK_LOCK) !!}</td>
		</tr>
		<tr>
			<td class="w108">理由:</td>
			<td>
...
<div id="detail_unlock" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.lock', 'id' => 'form_unlock']) !!}
	{!! Form::hidden('lock', \App\Lemon\Dailian\Application\Platform\Tong::LOCK_UNLOCK) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	<table class="table">
		<tr>
			<td>变更状态</td>
			<td>{!! \App\Lemon\Dailian\Application\Platform\Tong::kvLock(\App\Lemon\Dailian\Application\Platform\Tong::LOCK_UNLOCK) !!}</td>
		</tr>
		<tr>
			<td class="w108">理由:</td>
			<td>
...
<div id="detail_money" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.special', 'id' => 'form_money']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	{!! Form::hidden('type', \App\Lemon\Dailian\Application\Platform\Tong::MODIFY_MONEY) !!}
	<table class="table">
		<tr>
...
<div id="detail_time" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.special', 'id' => 'form_time']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	{!! Form::hidden('type', \App\Lemon\Dailian\Application\Platform\Tong::MODIFY_TIME) !!}
	<table class="table">
		<tr>
...
<div id="detail_game_pwd" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.special', 'id' => 'form_game_pwd']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	{!! Form::hidden('type', \App\Lemon\Dailian\Application\Platform\Tong::MODIFY_GAME_WORD) !!}
	<table class="table">
		<tr>
...
<div id="detail_picture" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.progress', 'id' => 'form_picture', 'files'=> true]) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	<table class="table">
		<tr>
			<td class="w108">图片:</td>
...
<div id="detail_star" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.star', 'id' => 'form_star']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	<table class="table">
		<tr>
			<td class="w108">评价:</td>
			<td>{!! Form::radios('flag', \App\Lemon\Dailian\Application\Platform\Tong::kvStar(), null, [
			  'desktop' => true
			]) !!} </td>
		</tr>
		<tr>
...
<div id="detail_cancel_apply" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.cancel', 'id'=> 'form_tong_pub_cancel']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	{!! Form::hidden('flag', \App\Lemon\Dailian\Application\Platform\Tong::PUB_CANCEL_APPLY) !!}
	<table class="table">
		<tr>
	...
	require(['jquery', 'lemon/util', 'jquery.validate', 'jquery.form'], function ($, util) {
		...
		$('#form_tong_pub_cancel').validate(conf);
	});
	</script>
</div>
<div id="detail_cancel_cancel" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.cancel']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	{!! Form::hidden('flag', \App\Lemon\Dailian\Application\Platform\Tong::PUB_CANCEL_CANCEL) !!}
	<table class="table">
		<tr>
			<td class="w108">撤销标记:</td>
			<td>取消撤销</td>
...
<div id="detail_sd_cancel_handle" class="hidden">
	{!! Form::open(['route' => 'dsk_platform_status_tong.cancel']) !!}
	{!! Form::hidden('status_id', $status->id) !!}
	{!! Form::hidden('flag', \App\Lemon\Dailian\Application\Platform\Tong::PUB_CANCEL_AGREE) !!}
	<table class="table">
		<tr>
			<td class="w108">撤销标记:</td>
			<td>处理撤销</td>
		...
		<tr>
			...
			<td>
				<p class="mb5">
					{!! Form::label('order_price', '您已预付的代练费') !!} ¥ {!! $status->tong_order_price !!} 元
				</p>
				<div class="form-group clearfix mb5 ">
